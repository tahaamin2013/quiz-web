...
const page = () => {
    ...
    const questions: Record<number, string[]> = {
        1: [
            "امن خراب کا پکا ہوگا۔",
            "مہمان آچکے ہوں گے۔",
            "ہم آرام کر سکتے ہوں گے۔",
            "چوکیدار گھر چاہتا ہوگا۔",
            "تم بحث کر چکے ہوں گے۔",
            "انھوں نے تمہاری جدائی ہوگی۔",
        ...
        3: [
            ...
            "انھوں نے اپنا کام کیوں ادھورا چھوڑ دیا ہو گا؟",
            ...
            "کیا تمھارا جینا مقابلے میں امتیاز حاصل کر چکا ہوگا؟",
            "کیا قاتل صاف بچ کر نکل گیا ہو گا؟",

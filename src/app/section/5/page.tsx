...
const page = () => {
    const sections = [
        { id: 1, title: "Affirmative sentences (Past Simple Tense)", url: "/section/1/1" },
        { id: 2, title: "Negative sentences and Interrogative Sentences (Past Simple Tense)", url: "/section/1/2" },
    ];
